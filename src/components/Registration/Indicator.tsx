...
export default function Indicator({ className = "", items, active }: Props) {
    return (
        <div
            className={`grid rounded-full overflow-hidden h-1.5 bg-light bg-opacity-10 backdrop-blur fixed top-0 left-1/2 -translate-x-1/2 z-[1] w-full max-w-screen gap-px ${className}`}
