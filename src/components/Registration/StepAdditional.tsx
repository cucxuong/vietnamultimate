                    ...
                    <div className="grid gap-0.5">
                        <div className="rounded rounded-t-3xl bg-foreground bg-opacity-5 backdrop-blur-xl grid gap-4 p-4 lg:p-6">
                            ...
                            <div className="grid text-sm lg:text-base gap-2">
                                ...
                                {new Date().getTime() <= new Date(2023, 10, 27, 12, 0, 0).getTime() && <p>{t("You can prepare yourself or order tournament jersey designs.")}</p>}
                            </div>
                        </div>

                        {new Date().getTime() <= new Date(2023, 10, 27, 12, 0, 0).getTime() && (
                            <>
